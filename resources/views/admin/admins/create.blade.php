                            ...
                            <form class="needs-validation" action="{{ route('admin.admins.store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control validate" value="{{ old('name') }}"
                                            name="name" required id="exampleInputName1"
                                            placeholder="{{ __('Name') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control validate" value="{{ old('phone') }}"
                                            name="phone" id="" placeholder="{{ __('Mobile') }}">
                                        <div class="invalid-feedback">
                                            Mobile is required
                                        </div>
                                        @error('phone')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control validate" value="{{ old('email') }}"
                                            name="email" id="exampleInputEmail3" placeholder="{{ __('Email') }}">
                                        <div class="invalid-feedback">
                                            Email is required
                                        </div>
                                        @error('email')
