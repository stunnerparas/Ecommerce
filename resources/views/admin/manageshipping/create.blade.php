            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" action="{{ route('admin.manageshipping.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('tracking_number') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('estimated_arrival_date') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('tracking_url') }}" name="tracking_url"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ old('shipping_status') }}"
