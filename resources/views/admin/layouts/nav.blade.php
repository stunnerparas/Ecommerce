<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto" method="GET" action="{{ route('admin.global.search.page') }}">
        ...
        <div class="search-element" style="display: flex">
            <input class="form-control" name="query" autocomplete="off" id="search-input" type="search"
