    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @canany([
                ...
                <li
                    class="dropdown {{ Request::segment(2) == 'sliders' || Request::segment(2) == 'blogs' || Request::segment(2) == 'coupon' || Request::segment(2) == 'currency' || Request::segment(2) == 'deals' || Request::segment(2) == 'company' || Request::segment(2) == 'pages' || Request::segment(2) == 'faqs' ? 'active' : '' }}">
        ...
        {{-- @can('View Ticket') --}}
        <li
            class="{{ Request::segment(2) == 'components' || Request::segment(2) == 'componenttypes' ? 'active' : '' }}">
        ...
        {{-- @can('View Ticket') --}}
        <li class="{{ Request::segment(2) == 'helpcenter' ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.helpcenter.index') }}"><i class="fas fa-envelope"></i>
