    ...
    <div class="container-fluid my-5">
        <div class="container">
            <div class="edit-container mt-3">
                <form action="{{ route('shipping.details.update') }}" method="POST">
                    ...
                    <div class="shipping-form-inner">
                        ...
                        <div class="row my-3">
                            <div class="col-sm-6 col-12 mb-3 mb-sm-0">
                                ...
                                <input type="text" value="{{ $shipping->full_name ?? '' }}" name="full_name"
                                    class="form-control p-4" placeholder="Full Name">
                            </div>
                            <div class="col-sm-6 col-12">
                                <!-- Last Name for shipping -->
                                <input type="email" value="{{ $shipping->email ?? '' }}" name="email"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <!-- Address of shipping -->
                                <input type="text" value="{{ $shipping->address ?? '' }}" name="address"
                        ...
                        <div class="row mb-3 ">
                            <div class="col ">
                                ...
                                <input type="text " value="{{ $shipping->apartment ?? '' }}" name="apartment"
                        ...
                        <div class="row mb-3 ">
                            <div class="col ">
                                <input type="text " value="{{ $shipping->country ?? '' }}" name="country"
