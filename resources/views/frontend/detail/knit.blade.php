        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-md-6 col-sm-12 yarn-content">
                    <!-- Heading -->
                    <div class="heading">
                        <h2 class="py-2 text-center">{{ $knit->title ?? '' }}</h2>

                        <p class="text-justify">{!! $knit->description !!}</p>

                    </div>
                </div>
                <div class="col-lg-5 col-md-6 d-none d-md-block yarn-image">
                    <img src="{{ asset('images/' . $knit->image) }}" class="w-100 h-100" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 my-3">
                            <div class="knit-box">
                                ...
                                <div class="knit-heading pt-3">
                                    <span class="service-heading d-block text-center">{{ $category->title ?? '' }}</span>
                                </div>
                            </div>
