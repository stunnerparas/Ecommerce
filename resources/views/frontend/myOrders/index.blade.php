                            ...
                            <div class="order-detail-box my-3">
                                ...
                                <div class="order-detail-top">
                                    ...
                                    <div class="orderNumber d-flex">
                                        ...
                                        <h3 class="page-heading px-2">#{{ $order->order_number }}</h3>
                                    </div>
                                    <div class="order-detail-date d-flex my-2">
                                        <!-- Delivered date -->
                                        <div class="delivered-date">
                                            <h5> <i class="bi bi-calendar-check-fill mx-2"></i>Date :
                                        ...
                                        <div class="product-container">
                                            ...
                                            <div class="product-box d-flex">
                                                ...
                                                <div class="product-rate">
                                                    <h4>{{ currencyDBSymbol($order->currency) }}{{ $subTotal ?? 0 }}</h4>
                                                    <h5>Qty {{ $item->quantity ?? 0 }}</h5>
                                ...
                                <div class="order-detail-heading d-flex w-100 justify-content-end">
                                    {{-- <h2>My Orders</h2> --}}
                                    <!-- Total price -->
                                    <div class="total-price d-flex py-2">
                                        <a href="{{ route('order.details', $order->id) }}"><p class="text-underline">View More</p></a>
                                    </div>
                                </div>
                            </div>
