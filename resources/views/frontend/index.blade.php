            ...
            <a href="{{ $mainBanner->btn_link ?? '' }}">
                <div class="page-banner-container">
                    ...
                    <div class="hero-banner-desc">
                        <img src="{{ asset('images/' . ($mainBanner->image ?? '')) }}" class="w-100 h-100 hero-banner-image"
                            alt="" />
    ...
    @foreach ($collections as $key => $collection)
        ...
        @else
            <section class="classic-collection my-2">
                ...
                <div class="signature-collection-product py-4">
                    <div class="container">
                        <div class="row product_filter">
                            @foreach (getProductsFromType($collection->slug, 3) as $item)
                                @include('frontend.component.product', ['product' => $item])
                            @endforeach
                            <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 signature-link-container">
                                <a href="{{ route('filter', ['type' => 'collection', 'slug' => $collection->slug]) }}"
                                    class="my-5 signature-link">← {{ $collection->type ?? '' }}</a>
...
<section class="signature-collection my-3">
    ...
    <div class="page-banner-container">
        ...
        <div class="hero-banner-mob">
            <img src="{{ asset('images/' . ($signatureBanner->image ?? '')) }}" class="w-100 h-100" alt="">
        </div>
        <div class="banner-content">
            <div class="row">
                <div class="col-lg-5 col-md-10">
    ...
    <div class="signature-collection-product py-4">
        <div class="container">
            <div class="row product_filter">
                ...
                @endforeach
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 signature-link-container">
                    <a href="{{ route('filter', ['type' => 'collection', 'slug' => 'classic']) }}" class="my-5 signature-link">← The Classic Collection</a>
                </div>
            </div>
        </div>
    </div>
        ...
        @if ($menBanner)
            <a href="{{ route('filter', ['type' => 'category', 'slug' => 'men']) }}">
                <div class="page-banner-container">
                    <!-- Banner image -->
                    <div class="hero-banner-desc">
                        <img src="{{ asset('images/' . ($menBanner->image ?? '')) }}"
                            class="w-100 h-100 hero-banner-image" alt="" />

                    </div>
                    <div class="hero-banner-mob">
                        <img src="{{ asset('images/' . ($menBanner->image ?? '')) }}" class="w-100 h-100"
                            alt="">
                    </div>
                    <div class="banner-content">
                        <div class="row">
            ...
            <div class="container">
                <div class="row product_filter">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 men-link-container">
                        <a href="{{ route('filter', ['type' => 'category', 'slug' => 'men']) }}" class="my-5 men-link">←
                            The Men Collection</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        @if ($womenBanner)
            <a href="{{ route('filter', ['type' => 'category', 'slug' => 'women']) }}">
                <div class="page-banner-container">
                    <!-- Banner image -->
                    <div class="hero-banner-desc">
                        <img src="{{ asset('images/' . ($womenBanner->image ?? '')) }}"
                            class="w-100 h-100 hero-banner-image" alt="" />

                    </div>
                    <div class="hero-banner-mob">
                        <img src="{{ asset('images/' . ($womenBanner->image ?? '')) }}" class="w-100 h-100"
                            alt="">
                    </div>
                    <div class="banner-content">
                        <div class="row">
